...
declare module 'react-native-reanimated' {
  ...
  export type TimingAnimation =
    import('react-native-reanimated/lib/types/lib/reanimated2/animation').TimingAnimation;
  export type SpringAnimation =
    import('react-native-reanimated/lib/types/lib/reanimated2/animation').SpringAnimation;
  export type DecayAnimation =
    import('react-native-reanimated/lib/types/lib/reanimated2/animation').DecayAnimation;
  export type DelayAnimation =
    import('react-native-reanimated/lib/types/lib/reanimated2/animation/commonTypes').DelayAnimation;
  export type RepeatAnimation =
    import('react-native-reanimated/lib/types/lib/reanimated2/animation').RepeatAnimation;
  export type SequenceAnimation =
    import('react-native-reanimated/lib/types/lib/reanimated2/animation').SequenceAnimation;
  export type StyleLayoutAnimation =
    import('react-native-reanimated/lib/types/lib/reanimated2/animation').StyleLayoutAnimation;
  export type Animation<T> =
    import('react-native-reanimated/lib/types/lib/reanimated2/commonTypes').Animation<T>;
  export type MeasuredDimensions =
    import('react-native-reanimated/lib/types/lib/reanimated2/commonTypes').MeasuredDimensions;
