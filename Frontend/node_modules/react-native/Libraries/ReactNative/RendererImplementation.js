...
export function renderElement({
  ...
  if (useFabric) {
    require('react-native/Libraries/Renderer/shims/ReactFabric').render(
      element,
      rootTag,
      null,
      useConcurrentRoot,
    ...
    require('react-native/Libraries/Renderer/shims/ReactNative').render(element, rootTag);
  }
}
...
export function findHostInstance_DEPRECATED<TElementType: ElementType>(
  ...
  return require('react-native/Libraries/Renderer/shims/ReactNative').findHostInstance_DEPRECATED(
    componentOrHandle,
  );
}
...
export function dispatchCommand(
  ...
  if (global.RN$Bridgeless === true) {
    ...
    return require('react-native/Libraries/Renderer/shims/ReactFabric').dispatchCommand(
      handle,
      command,
      args,
    );
  } else {
    return require('react-native/Libraries/Renderer/shims/ReactNative').dispatchCommand(
      handle,
      command,
      args,
    );
...
export function sendAccessibilityEvent(
  ...
  return require('react-native/Libraries/Renderer/shims/ReactNative').sendAccessibilityEvent(
    handle,
    eventType,
  );
}
...
export function unmountComponentAtNodeAndRemoveContainer(rootTag: RootTag) {
  ...
  require('react-native/Libraries/Renderer/shims/ReactNative').unmountComponentAtNodeAndRemoveContainer(
    rootTagAsNumber,
  );
}
